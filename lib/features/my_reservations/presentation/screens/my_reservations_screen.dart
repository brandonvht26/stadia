          ...
          if (provider.reservations.isEmpty) {
            return Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.event_busy, size: 64, color: colorScheme.onSurface.withOpacity(0.3)),
                  const SizedBox(height: 16),
                  Text(
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Padding(
                  padding: EdgeInsets.only(bottom: AppSpacing.scaled(context, AppSpacing.md)),
                  child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(color: _getStatusColor(reservation.status).withOpacity(0.5)),
                                  ),
                                  child: Text(
                                ...
                                if (reservation.status == 'pending' || reservation.status == 'confirmed') ...[
                                  if (reservation.rescheduleCount == 0 && reservation.eventDate.difference(DateTime.now()).inHours >= 48)
                                    IconButton(
                                      icon: Icon(Icons.event_repeat, color: colorScheme.primary),
                            ...
                            Row(
                              children: [
                                Icon(Icons.attach_money, size: 16, color: colorScheme.onSurface.withOpacity(0.6)),
                                const SizedBox(width: 8),
                                Text(
